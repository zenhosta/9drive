  ...
  return (
    <>
      ...
      <div className="fixed inset-x-3 bottom-3 z-50 rounded-3xl border border-slate-200/80 bg-white/95 p-2 shadow-2xl shadow-slate-950/10 backdrop-blur-xl dark:border-slate-800/80 dark:bg-slate-900/95 sm:inset-x-auto sm:bottom-auto sm:w-52 sm:rounded-2xl" style={{ left: window.innerWidth >= 640 ? safeX : undefined, top: window.innerWidth >= 640 ? safeY : undefined }}>
        <p className="truncate px-3 py-2 text-xs font-extrabold text-slate-700 dark:text-slate-400 border-b border-slate-100 dark:border-slate-800 mb-1">{file.name}</p>
        <Button variant="ghost" className="h-10 w-full justify-start text-[13px] font-bold text-slate-700 dark:text-slate-300 hover:bg-slate-100/80 dark:hover:bg-slate-800/80 transition-colors duration-150" onClick={onView}><Eye className="h-4 w-4 text-slate-500" />View</Button>
        <Button variant="ghost" className="h-10 w-full justify-start text-[13px] font-bold text-slate-700 dark:text-slate-300 hover:bg-slate-100/80 dark:hover:bg-slate-800/80 transition-colors duration-150" onClick={onDownload}><Download className="h-4 w-4 text-slate-500" />Download</Button>
        ...
        <Button variant="ghost" className="h-10 w-full justify-start text-[13px] font-bold text-slate-700 dark:text-slate-300 hover:bg-slate-100/80 dark:hover:bg-slate-800/80 transition-colors duration-150" onClick={onMove}><FolderInput className="h-4 w-4 text-slate-500" />Move to Folder</Button>
        <Button variant="ghost" className="h-10 w-full justify-start text-[13px] font-bold text-slate-700 dark:text-slate-300 hover:bg-slate-100/80 dark:hover:bg-slate-800/80 transition-colors duration-150" onClick={onDetails}><Info className="h-4 w-4 text-slate-500" />Details</Button>
        <Button variant="ghost" className="h-10 w-full justify-start text-[13px] font-bold text-slate-700 dark:text-slate-300 hover:bg-slate-100/80 dark:hover:bg-slate-800/80 transition-colors duration-150" onClick={onShare}><Link2 className="h-4 w-4 text-slate-500" />Share Link</Button>
